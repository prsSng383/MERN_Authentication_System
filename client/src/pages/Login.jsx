...
const Login = () => {
  ...
  const toastMessages = [
    ...
    "Hang tight, this may take a bit...",
    "Just a few more seconds...",
    "Thank you for your patience 🙏",
    "Server should respond shortly...",
    "If it takes too long, try refreshing!"
  ];
  ...
  const onSubmitHandler = async (e) => {
    ...
    // Toast message interval logic
    let messageIndex = 0;
    const showProgressiveToasts = () => {
      const intervalId = setInterval(() => {
        if (messageIndex < toastMessages.length && loading) {
          toast.info(toastMessages[messageIndex], { autoClose: 3000 });
          messageIndex++;
        } else {
      ...
      toastTimers.push(intervalId);
    };

    showProgressiveToasts();
    ...
    try {
      ...
      toastTimers.forEach((id) => clearInterval(id));
      setLoading(false);
    }
  };
